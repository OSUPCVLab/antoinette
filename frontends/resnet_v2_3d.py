...
from frontends import resnet_utils_3d as resnet_utils_3d
...
def bottleneck(inputs, depth, depth_bottleneck, stride, rate=1,
  ...
  with tf.variable_scope(scope, 'bottleneck_v2', [inputs]) as sc:
    ...
    if depth == depth_in:
      ...
      shortcut = slim.conv3d(preact, depth, [1, 1, 1], stride=stride,
                             normalizer_fn=None, activation_fn=None,
                             scope='shortcut')

    residual = slim.conv3d(preact, depth_bottleneck, [1, 1, 1], stride=1,
                           scope='conv1')
    ...
    with slim.arg_scope([slim.conv2d, bottleneck,
      ...
      with slim.arg_scope([slim.batch_norm], is_training=is_training):
        ...
        if include_root_block:
          ...
          net = slim.max_pool3d(net, [3, 3, 3], stride=2, scope='pool1')
