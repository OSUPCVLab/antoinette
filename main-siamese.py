...
def main():
    time_length = 20
    # train_lab, val_lab, test_lab = utils.prepare_data('U:\\Datasets\\Data\\PoseTrack')
    train_lab, val_lab, test_lab = utils.prepare_data("C:\\Users\\ajamgard.1\\Desktop\\TemporalPose\\Data\\PoseTrack")
    ...
    network = model_builder.build_model(model_name='Siamese-Encoder-Decoder-Skip',frontend ='ResNet101', net_input=net_input, num_classes=num_classes)
    ...
    #10 ** (-0.8041131914987947), decay = 0.995
    ...
    for epoch in range(EPOCHS):
        ...
        if epoch % 1 == 0:
            ...
            for ind in val_indices:
                ...
                #print(np.shape(input_image[0,time_length-1,:,:]))
                input_image = input_image[0,0,time_length-1,:,:].reshape((64,64,3))
