...
def main():
    ...
    # model_checkpoint_name = os.path.join(base_dir , "snapshot\\latest_model_EncoderDecoder.ckpt")
    ...
    #
    	...
    	for i in range(time_length):
    		...
    		input_image_i = input_image[0,i,:,:,:] * train_std + train_mean
